    ...
    <nav class="navbar navbar-expand bg-light mb-2">
        <div class="container-fluid">
            <div class="navbar-brand">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-vinyl-fill"
                    viewBox="0 0 16 16">
            ...
            <div class="btn-group">
                ...
                <router-link to="/create" class="btn btn-outline-dark"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
